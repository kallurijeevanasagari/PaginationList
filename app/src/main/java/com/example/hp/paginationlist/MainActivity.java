package com.example.hp.paginationlist;
...
public class MainActivity extends Activity {
    ...
    public int TOTAL_LIST_ITEMS = 500;
    ...
    private void CheckBtnBackGroud(int index)
    {
        ...
        for(int i=0;i<noOfBtns;i++)
        {
            if(i==index)
            {
                btns[index].setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_action_name));
